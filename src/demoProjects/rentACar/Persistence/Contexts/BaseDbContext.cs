...
namespace Persistence.Contexts
{
    public class BaseDbContext : DbContext
    {
        ...
        {
            // this process for custom db and column names
            ...
            modelBuilder.Entity<Model>(a =>
            {
                ...
                //brand relation (only 1 brand of this model)
                a.HasOne(p => p.Brand);
            });

            // default db data per migration
            Brand[] brandEntitySeeds = { new(1, "BMW"), new(2, "Mercedes") };
            modelBuilder.Entity<Brand>().HasData(brandEntitySeeds);

            Model[] modelEntitySeeds = { new(1, 1, "Series 4", 1500, ""), new(2, 1, "Series 3", 1200, ""), new(3, 2, "A180", 2000, "") };
